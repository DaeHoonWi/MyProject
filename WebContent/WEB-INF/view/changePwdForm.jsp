...
<body>
	...
	<tr>
		...
		<tr>
			<th>현재 암호</th>
			<td><input type="password" name="curPwd">
				<c:if test="${errors.curPwd}">현재 암호를 입력하세요.</c:if>
				<c:if test="${errors.badCurPwd}">현재 암호가 일치하지 않습니다.</c:if>
			</td>
			<td rowspan="2"><input type="submit" value="" class="modify_pw_com_button"></td>
		</tr>
		<tr>
			<th>새 암호</th>
			<td>
		...
		<tr>
			<td colspan="3" style="border-top: 1px dashed #9b9b9b; padding-top: 10px">
			<p>외부로부터 회원님의 정보를 안전하게 보호하기 위해<br>
			패스워드를 확인하셔야 합니다.</p>
			</td>
		</tr>
	</table>
