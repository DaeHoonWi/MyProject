...
<body>
	...
	<!-- content -->
	<div class="login_table_os">
		<form action="login.do" method="post">
			<table class="login_table">
				<!-- 알림창 뜨는 방법으로 수정하기 -->
				<%-- <c:if test="${errors.idOrPwNotMatch}">아이디와 암호가 일치하지 않습니다.</c:if> --%>
				<tr>
					<td colspan="3"><img alt="로그인1" src="../image/login_tit.gif"></td>
				</tr>
				<tr>
					<td>아이디</td>
					<td><input type="text" name="id" value="${param.id}"></td>
					<td rowspan="2"><input type="submit" class="login_button"
				...
				<tr>
					<td colspan="3" style="border-top: 1px solid #808080" />
				</tr>
				<tr>
					<td colspan="2" style="font-size: 10px">· 회원이 되시면 다양한 혜택을 누리실
						수 있습니다.</td>
					<td><a href="join.do"><img alt="회원가입" src="../image/login_join.gif"></a></td>
				</tr>
				<tr>
					<td colspan="2" style="font-size: 10px">· 아이디와 비밀번호를 찾으실 수
						있습니다.</td>
					<td><a href=""><img alt="아이디/비밀번호 찾기" src="../image/login_sch.gif"></a></td>
				</tr>
